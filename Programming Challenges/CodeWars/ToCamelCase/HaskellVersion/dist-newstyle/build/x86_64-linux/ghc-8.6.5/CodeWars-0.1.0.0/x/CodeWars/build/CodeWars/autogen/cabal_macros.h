...
/* package CodeWars-0.1.0.0 */
#ifndef VERSION_CodeWars
#define VERSION_CodeWars "0.1.0.0"
#endif /* VERSION_CodeWars */
#ifndef MIN_VERSION_CodeWars
#define MIN_VERSION_CodeWars(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CodeWars */
...
#define CURRENT_COMPONENT_ID "CodeWars-0.1.0.0-inplace-CodeWars"

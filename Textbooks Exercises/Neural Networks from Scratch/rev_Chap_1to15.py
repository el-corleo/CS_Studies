...
layer_1 = Layer_Dense(2, 32, weight_reg_L2=5e-4, bias_reg_L2=5e-4)
act_func_1 = Activation_ReLU()
dropout_1 = Layer_Dropout(0.1)
layer_2 = Layer_Dense(32, 16)
act_func_2 = Activation_ReLU()
dropout_2 = Layer_Dropout(0.1)
layer_3 = Layer_Dense(16, 8)
act_func_3 = Activation_ReLU()
dropout_3 = Layer_Dropout(0.1)
layer_4 = Layer_Dense(8, 3)
...
for epoch in range(10001):
    ...
    dropout_1.forward(act_func_1.outputs)
    layer_2.forward(dropout_1.outputs)
    act_func_2.forward(layer_2.outputs)
    dropout_2.forward(act_func_2.outputs)
    layer_3.forward(dropout_2.outputs)
    act_func_3.forward(layer_3.outputs)
    dropout_3.forward(act_func_3.outputs)
    layer_4.forward(dropout_3.outputs)
    ...
    dropout_3.backward(layer_4.dinputs)
    act_func_3.backward(dropout_3.dinputs)
    layer_3.backward(act_func_3.dinputs)
    dropout_2.backward(layer_3.dinputs)
    act_func_2.backward(dropout_2.dinputs)
    layer_2.backward(act_func_2.dinputs)
    dropout_1.backward(layer_2.dinputs)
    act_func_1.backward(dropout_1.dinputs)
